        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK-Email", "Email Like '%___@%___%.__%'");
                    table.CheckConstraint("CK-Phone", "Phone Like '010%' or Phone Like'011%' or Phone like '012%' or Phone Like'015%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK-Email1", "Email Like '%___@%___%.__%'");
                    table.CheckConstraint("CK-Phone1", "Phone Like '010%' or Phone Like'011%' or Phone like '012%' or Phone Like'015%'");
                });
            ...
            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "Description", "DurationDays", "IsActive", "Name", "Price", "UpdateAt" },
                values: new object[,]
                {
                    { 1, "Access to gym equiment during staffed hours.", 30, true, "Basic Plan", 300m, null },
                    { 2, "Includes Basic Plan benefits plus access to group classes.", 60, false, "Standard Plan", 500m, null },
                    { 3, "Unlimited access to equiment classes and sauna.", 90, false, "Premium Plan", 900m, null },
